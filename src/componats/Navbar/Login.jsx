...
const Login = () => {
  return (
    <div>
        <form action="" className='w-1/2 mx-auto bg-gray-800 mt-10 p-10 text-white shadow-2xl rounded-2xl'>
           ...
           <button className='  flex items-center gap-3 px-4 py-2 bg-white text-black font-bold rounded-2xl cursor-pointer '><AiFillGoogleSquare size={30} /> <span>SignInWithGoogle</span>
           </button>
